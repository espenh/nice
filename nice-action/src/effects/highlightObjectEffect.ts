...
export class HighlightObjectEffect implements IEffect {
    ...
    constructor(private readonly object: IPlacedObject, private wantedEffectLengthInMs = 2000) {
    }
    ...
    tick(ellapsedMilliseconds: number, props: IEffectProps): ColorsByIndex {
        ...
        return _.fromPairs(lowerLeds.concat(higherLeds).map(led => [led, { r: redness, g: 0, b: 0 }]));
    }
}
