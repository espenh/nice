...
export const MappingSection: React.FunctionComponent = () => {
  return (
    <section>
      ...
      <StoryParagraph>
        Since we want to control the LEDs based on their position on the ice, we need to know their 2D position in the frame captured by the camera. on the ice Using the Twinkly LED API, specific LEDs are addressed using their index - their position on the wire. 
      </StoryParagraph>
      <StoryParagraph>
